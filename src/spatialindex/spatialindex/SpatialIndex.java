...
public class SpatialIndex
{
	...
	public static final int RtreeVariantQuadratic = 1;//quadratic浠ｈ〃浜屾鐨勩�佷簩娆℃柟绋嬪紡
	public static final int RtreeVariantLinear = 2;//linear琛ㄧず绾挎�х殑
	public static final int RtreeVariantRstar = 3;//Rstar琛ㄧず涓户鍗槦
